		...
		actors: [
			npc.merchant(0x0C, 0x0C, 0x04, 0x52A5, {
				...
				requirements: {
					...
					hard: 'HOLY_WATER || NAIL',
					none: 'HOLY_WATER || NAIL'
				}
			})
		],
		ceiling: true
		...
		actors: [
			fixture.book(0x03, 0x15, 0x5C, 0x51F4, {
				...
				requirements: {
					...
					hard: 'HOLY_WATER || EYEBALL',
					none: 'HOLY_WATER || EYEBALL'
				}
			})
		],
		ceiling: true
		...
		actors: [
			npc.merchant(0x0C, 0x1A, 0x00, 0x5209, {
				...
				requirements: {
					...
					hard: 'LAURELS || (WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL)'
				}
			})
		],
		ceiling: true
	...
	},
	{
		...
		actors: [
			npc.crystalDude(0x02, 0x34, 0x01, 0x5A65, {
				...
				requirements: {
					standard: 'LAURELS && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL && (HOLY_WATER || NAIL)',
					hard: 'LAURELS',
					none: 'LAURELS'
				}
			}),
	...
	},
	{
		...
		actors: [
			fixture.orb(0x0D, 0x07, 0x1C, 0x5ACB, {
				...
				textPointer: 0xD023,
				requirements: {
					standard: 'LAURELS && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL && OAK_STAKE && (HOLY_WATER || NAIL)',
					hard: 'LAURELS && OAK_STAKE',
					none: 'LAURELS && OAK_STAKE'
				}
			})
		],
		ceiling: true
		...
		actors: [
			...
			fixture.book(0x3E, 0x0C, 0x1E, 0x5B38, {
				...
				requirements: {
					...
					hard: 'HOLY_WATER || NAIL || EYEBALL',
					none: 'HOLY_WATER || NAIL || EYEBALL'
				}
			})
		],
		ceiling: true
		...
		actors: [
			...
			npc.merchant(0x38, 0x28, 0x06, 0x5C47, {
				...
				requirements: {
					...
					hard: 'WHITE_CRYSTAL && BLUE_CRYSTAL',
					none: 'WHITE_CRYSTAL && BLUE_CRYSTAL'
				}
			}),
			fixture.orb(0x3D, 0x15, 0x19, 0x5C4B, {
				...
				requirements: {
					...
					hard: 'WHITE_CRYSTAL && BLUE_CRYSTAL && OAK_STAKE',
					none: 'WHITE_CRYSTAL && BLUE_CRYSTAL && OAK_STAKE'
				}
			}),
			fixture.book(0x3E, 0x08, 0x21, 0x5C4F, {
				...
				requirements: {
					...
					hard: '(HOLY_WATER || NAIL || EYEBALL) && WHITE_CRYSTAL && BLUE_CRYSTAL',
					none: '(HOLY_WATER || NAIL || EYEBALL) && WHITE_CRYSTAL && BLUE_CRYSTAL'
				}
			}),
		...
		actors: [
			fixture.book(0x01, 0x10, 0x23, 0x5C60, {
				...
				requirements: {
					...
					hard: 'HOLY_WATER && HEART',
					none: 'HOLY_WATER && HEART'
				}
			}),
		...
		actors: [
			...
			fixture.book(0x0E, 0x18, 0x24, 0x5CD9, {
				...
				requirements: {
					...
					hard: '(HOLY_WATER || NAIL || EYEBALL) && HEART',
					none: '(HOLY_WATER || NAIL || EYEBALL) && HEART'
				}
			})
		],
		ceiling: true
		...
		actors: [
			fixture.orb(0x0D, 0x07, 0x1A, 0x5CE3, {
				...
				requirements: {
					...
					hard: 'HEART && OAK_STAKE',
					none: 'HEART && OAK_STAKE'
				}
			})
		],
		ceiling: true
		...
		actors: [
			...
			npc.merchant(0x18, 0x2A, 0x06, 0x5F97, {
				...
				requirements: {
					...
					hard: '(HOLY_WATER || NAIL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || LAURELS)',
					none: '(HOLY_WATER || NAIL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || LAURELS)'
				}
			}),
			...
			fixture.orb(0x2D, 0x31, 0x1B, 0x5FAB, {
				...
				textPointer: 0xD002,
				requirements: {
					standard: '(HOLY_WATER || NAIL) && OAK_STAKE && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL',
					hard: '(HOLY_WATER || NAIL) && OAK_STAKE && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || LAURELS)',
					none: '(HOLY_WATER || NAIL) && OAK_STAKE && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || LAURELS)'
				}
			}),
	...
	},
	{
		...
		actors: [
			...
			fixture.book(0x3A, 0x0D, 0x11, 0x7284, {
				...
				textPointer: 0xCF0B,
				requirements: {
					standard: '(HOLY_WATER || NAIL || EYEBALL) && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL',
					hard: '(HOLY_WATER || NAIL || EYEBALL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || LAURELS)',
					none: '(HOLY_WATER || NAIL || EYEBALL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || LAURELS)'
				}
			}),
