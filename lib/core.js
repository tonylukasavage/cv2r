...
const core = [
	...
	},
	{
		...
		doors: {
			requirements: {
				beginner:'WHITE_CRYSTAL && THORN_WHIP && HOLY_WATER',
				standard: '',
				glitch: '',
				diamondWarp: ''
			},
	...
	},
	{
		...
		actors: [
			npc.crystalDude(0x08, 0x0C, 0x03, 0x517C, {
				...
				requirements: {
					beginner: 'WHITE_CRYSTAL && HOLY_WATER && THORN_WHIP',
					standard: '',
					glitch: '',
					diamondWarp: ''
				},
	...
	},
	{
		...
		actors: [
			fixture.book(0x03, 0x15, 0x5C, 0x51F4, {
				...
				requirements: {
					beginner: '(HOLY WATER || EYEBALL) && THORN_WHIP && WHITE_CRYSTAL',
					standard: '(HOLY_WATER || EYEBALL)',
					glitch: '(HOLY_WATER || EYEBALL)',
					diamondWarp: '(HOLY_WATER || EYEBALL)'
				}
	...
	},
	{
		...
		doors: {
			requirements: {
				beginner:'WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL && THORN_WHIP && HOLY_WATER && LAURELS',
				standard: 'WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL',
				glitch: '(WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || LAURELS',
				diamondWarp: 'WHITE_CRYSTAL && BLUE_CRYSTAL && (HOLY_WATER || NAIL) && LAURELS'
			},
			data: [
				{
					name: 'Laruba Mansion - Door',
	...
	},
	{
		...
		doors: {
			requirements: {
				beginner:'WHITE_CRYSTAL && BLUE_CRYSTAL && THORN_WHIP && HOLY_WATER',
	...
	},
	{
		...
		doors: {
			requirements: {
				beginner:'WHITE_CRYSTAL && THORN_WHIP && HOLY_WATER && HEART',
				standard: 'HEART',
				glitch: 'HEART',
				diamondWarp: 'HEART'
			},
	...
	},
	{
		...
		actors: [
			...
			npc.merchant(0x1D, 0x0C, 0x06, 0x5AA1, {
				...
				requirements: {
					beginner: 'HOLY_WATER && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL && LAURELS',
					standard: '(HOLY_WATER || NAIL) && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL && LAURELS',
					glitch: 'LAURELS',
					diamondWarp: '(HOLY_WATER || NAIL) && WHITE_CRYSTAL && BLUE_CRYSTAL && LAURELS'
				}
			}),
	...
	},
	{
		...
		actors: [
			...
			fixture.book(0x3E, 0x0C, 0x1E, 0x5B38, {
				...
				requirements: {
					beginner: 'HOLY_WATER || NAIL || EYEBALL && WHITE_CRYSTAL',
	...
	},
	{
		...
		actors: [
			...
			fixture.orb(0x3D, 0x15, 0x18, 0x5B99, {
				...
				requirements: {
					beginner: 'WHITE_CRYSTAL && THORN_WHIP && HOLY_WATER && OAK_STAKE',
	...
	},
	{
		...
		actors: [
			...
			fixture.orb(0x3D, 0x15, 0x19, 0x5C4B, {
				...
				requirements: {
					beginner: 'WHITE_CRYSTAL && BLUE_CRYSTAL && OAK_STAKE && HOLY_WATER && THORN_WHIP',
			...
			fixture.book(0x3E, 0x08, 0x21, 0x5C4F, {
				...
				requirements: {
					beginner: '(HOLY_WATER || NAIL || EYEBALL) && WHITE_CRYSTAL && BLUE_CRYSTAL',
			...
			fixture.book(0x3E, 0x22, 0x22, 0x5C53, {
				...
				requirements: {
					beginner: '(HOLY_WATER || NAIL || EYEBALL) && WHITE_CRYSTAL && BLUE_CRYSTAL && THORN_WHIP',
					standard: '(HOLY_WATER || NAIL || EYEBALL) && WHITE_CRYSTAL && BLUE_CRYSTAL',
					glitch: '(HOLY_WATER || NAIL || EYEBALL) && WHITE_CRYSTAL && BLUE_CRYSTAL',
					diamondWarp: '(HOLY_WATER || NAIL || EYEBALL) && WHITE_CRYSTAL && BLUE_CRYSTAL'
				}
	...
	},
	{
		...
		actors: [
			...
			npc.merchant(0x23, 0x16, 0x06, 0x5CA0, {
				...
				requirements: {
					beginner: 'HEART && HOLY_WATER && WHITE_CRYSTAL && THORN_WHIP',
					standard: 'HEART',
					glitch: 'HEART',
					diamondWarp: 'HEART'
				}
	...
	},
	{
		...
		actors: [
			...
			fixture.book(0x0E, 0x18, 0x24, 0x5CD9, {
				...
				requirements: {
					beginner: '(HOLY_WATER || NAIL || EYEBALL) && HEART && WHITE_CRYSTAL && THORN_WHIP',
	...
	},
	{
		...
		actors: [
			fixture.orb(0x0D, 0x07, 0x1A, 0x5CE3, {
				...
				requirements: {
					beginner: 'HEART && WHITE_CRYSTAL && OAK_STAKE && THORN_WHIP',
	...
	},
	{
		...
		actors: [
			...
			npc.merchant(0x18, 0x2A, 0x06, 0x5F97, {
				...
				requirements: {
					beginner: 'HOLY_WATER && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL && THORN_WHIP',
			...
			fixture.orb(0x2D, 0x31, 0x1B, 0x5FAB, {
				...
				requirements: {
					beginner: 'HOLY_WATER && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL && OAK_STAKE && THORN_WHIP',
	...
	},
	{
		...
		actors: [
			...
			fixture.book(0x05, 0x0D, 0x0D, 0x66D5, {
				...
				textPointer: 0xCE4C,
				requirements: {
					beginner: '(HOLY_WATER || EYEBALL) && WHITE_CRYSTAL && THORN_WHIP',
					standard: '(HOLY_WATER || EYEBALL)',
					glitch: '(HOLY_WATER || EYEBALL)',
					diamondWarp: '(HOLY_WATER || EYEBALL)'
				}
	...
	},
	{
		...
		actors: [
			npc.secretMerchant(0x04, 0x0C, 0x06, 0x6F32, {
				...
				textPointer: 0xCED8,
				requirements: {
					beginner: 'GARLIC && THORN_WHIP && WHITE_CRYSTAL && HOLY_WATER',
					standard: 'GARLIC',
					glitch: 'GARLIC',
					diamondWarp: 'GARLIC'
				},
	...
	},
	{
		...
		actors: [
			npc.secretMerchant(0x04, 0x0C, 0x02, 0x6F88, {
				...
				requirements: {
					beginner: 'GARLIC && HOLY_WATER && WHITE_CRYSTAL && THORN_WHIP',
					standard: 'GARLIC',
					glitch: 'GARLIC',
					diamondWarp: 'GARLIC'
				}
		...
		actors: [
			...
			npc.crystalDude(0x16, 0x28, 0x05, 0x72B1, {
				...
				requirements: {
					...
					standard: '(HOLY_WATER || NAIL) && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL',
					glitch: '(HOLY_WATER || NAIL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || LAURELS)',
					diamondWarp: '(HOLY_WATER || NAIL) && WHITE_CRYSTAL && BLUE_CRYSTAL'
				}
			}),
	...
	},
	{
		...
		actors: [
			npc.crystalDude(0x04, 0x0A, 0x00, 0x684F, {
				...
				requirements: {
					beginner: "HOLY_WATER && WHITE_CRYSTAL && THORN_WHIP && HEART",
					standard: 'HEART',
					glitch: 'HEART',
					diamondWarp: 'HEART'
				}
	...
	},
	{
		...
		actors: [
			fixture.book(0x06, 0x0B, 0x14, 0x6895, {
				...
				textPointer: 0xCF68,
				requirements: {
					beginner: '(HOLY_WATER || EYEBALL || NAIL) && WHITE_CRYSTAL && THORN_WHIP',
					standard: '(HOLY_WATER || EYEBALL)',
					glitch: '(HOLY_WATER || EYEBALL)',
					diamondWarp: '(HOLY_WATER || EYEBALL)'
				}
