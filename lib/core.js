...
const core = [
    ...
    },
    {
        ...
        submap: 0x02,
        actors: [
            enemy.leech(0x06, 0x0D, 0x04, 0x60B3, { deadhandPos: 0x0B }),
            // low priority sprite
    ...
    },
    {
        ...
        actors: [
            ...
            enemy.highJumpLeech(0x0C, 0x0D, 0x0F, 0x6F5F, { deadhandPos: 0x0B }),
            // low priority sprite
            enemy.swampGhoul(0x14, 0x0C, 0x0F, 0x6F67),
            // low priority sprite
            enemy.highJumpLeech(0x1C, 0x0D, 0x0F, 0x6F6F, { deadhandPos: 0x0B }),
            enemy.highJumpLeech(0x24, 0x0D, 0x0F, 0x6F73, { deadhandPos: 0x0B }),
            // low priority sprite
            enemy.swampGhoul(0x2C, 0x0C, 0x0F, 0x6F7B),
            enemy.highJumpLeech(0x34, 0x0D, 0x0F, 0x6F7F, { deadhandPos: 0x0B })
            // low priority sprite
        ]
    },
    {
    ...
    },
    {
        ...
        actors: [
            // low priority sprite
            enemy.highJumpLeech(0x0C, 0x0D, 0x0F, 0x722F, { deadhandPos: 0x0B }),
            enemy.swampGhoul(0x14, 0x0C, 0x0F, 0x7233),
            // low priority sprite
            enemy.highJumpLeech(0x1C, 0x0D, 0x0F, 0x723B, { deadhandPos: 0x0B }),
            enemy.highJumpLeech(0x24, 0x0D, 0x0F, 0x723F, { deadhandPos: 0x0B }),
            // low priority sprite
            enemy.swampGhoul(0x2C, 0x0C, 0x0F, 0x7247),
            enemy.highJumpLeech(0x34, 0x0D, 0x0F, 0x724B, { deadhandPos: 0x0B })
            // low priority sprite
        ]
    },
    {
