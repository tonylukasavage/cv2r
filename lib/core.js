	...
	},
	{
		...
		actors: [
			npc.crystalDude(0x02, 0x34, 0x01, 0x5A65, {
				...
				requirements: [ [ LAURELS, RING ], WHITE_CRYSTAL, BLUE_CRYSTAL, RED_CRYSTAL, [ HOLY_WATER, NAIL ] ]
			}),
	...
	},
	{
		...
		actors: [
			fixture.orb(0x0D, 0x07, 0x1C, 0x5ACB, {
				...
				text: 'you now\nprossess\ndracula\'s\nring.',
				textPointer: 0xD023,
				requirements: [ [ LAURELS, RING ], WHITE_CRYSTAL, BLUE_CRYSTAL, RED_CRYSTAL, STAKE, [ HOLY_WATER, NAIL ] ]
			})
		],
		ceiling: true
	},
	...
	},
	{
		...
		actors: [
			...
			fixture.orb(0x2D, 0x31, 0x1B, 0x5FAB, {
				...
				text: 'you now\nprossess\ndracula\'s\nnail.',
				textPointer: 0xD002,
				requirements: [ [ HOLY_WATER, NAIL ], WHITE_CRYSTAL, BLUE_CRYSTAL, RED_CRYSTAL, STAKE ]
			}),
