		...
		actors: [
			npc.crystalDude(0x02, 0x34, 0x01, 0x5A65, {
				...
				requirements: {
					...
					glitch: 'LAURELS',
					diamondWarp: '(HOLY_WATER || NAIL) && WHITE_CRYSTAL && BLUE_CRYSTAL && (RED_CRYSTAL || (MAGIC CROSS && DIAMOND)) && LAURELS'
				}
			}),
		...
		actors: [
			fixture.orb(0x0D, 0x07, 0x1C, 0x5ACB, {
				...
				requirements: {
					...
					diamondWarp: '(HOLY_WATER || NAIL) && WHITE_CRYSTAL && BLUE_CRYSTAL && (RED_CRYSTAL || (MAGIC CROSS && DIAMOND)) && OAK_STAKE && LAURELS'
				}
			})
		],
		ceiling: true
		...
		actors: [
			...
			npc.crystalDude(0x16, 0x28, 0x05, 0x72B1, {
				...
				requirements: {
					standard: '(HOLY_WATER || NAIL) && WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL',
					glitch: '(HOLY_WATER || NAIL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || LAURELS)',
					diamondWarp: '(HOLY_WATER || NAIL) && WHITE_CRYSTAL && BLUE_CRYSTAL && (RED_CRYSTAL || (MAGIC CROSS && DIAMOND))'
				}
			}),
