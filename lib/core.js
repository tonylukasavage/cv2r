		...
		actors: [
			npc.merchant(0x0C, 0x1A, 0x00, 0x5209, {
				...
				requirements: {
					...
					diamondWarp: '(WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || (DIAMOND && CROSS)'
				}
			})
		],
		ceiling: true
		...
		actors: [
			npc.crystalDude(0x02, 0x34, 0x01, 0x5A65, {
				...
				requirements: {
					...
					glitch: 'LAURELS',
					diamondWarp: '(HOLY_WATER || NAIL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || (DIAMOND && CROSS)) && LAURELS'
				}
			}),
		...
		actors: [
			fixture.orb(0x0D, 0x07, 0x1C, 0x5ACB, {
				...
				requirements: {
					...
					diamondWarp: '(HOLY_WATER || NAIL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || (DIAMOND && CROSS)) && OAK_STAKE && LAURELS'
				}
			})
		],
		ceiling: true
		...
		actors: [
			...
			npc.merchant(0x18, 0x2A, 0x06, 0x5F97, {
				...
				requirements: {
					...
					diamondWarp: '(HOLY_WATER || NAIL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || (DIAMOND && CROSS))'
				}
			}),
			...
			fixture.orb(0x2D, 0x31, 0x1B, 0x5FAB, {
				...
				requirements: {
					...
					diamondWarp: '(HOLY_WATER || NAIL) && ((WHITE_CRYSTAL && BLUE_CRYSTAL && RED_CRYSTAL) || (DIAMOND && CROSS)) && OAK_STAKE'
				}
			}),
