...
const npcs = [
  ...
  { 
    ...
    hack: function(item, opts = {}) {
      ...
      const sale = [ item.icon, Math.floor(item.price / 100), item.price % 100 ];

      // given item, create code 
      let code = [];
    ...
    //   sale: [ 0x5A, 0x01, 0x72 ],
    //   salePointer: 0x1ED3D,
    //   code: [ 0x20, 0x90, 0x9D, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA ],
    //   codePointer: 0x1EDFD,
    //   codeSize: 10,
    //   requirements: []
    // }
