...
const enemies = exports.enemies = [
	...
	{ name: 'bone dragon', id: BONE_DRAGON, pos: POS_GROUND, sprite: 0x05, projectile: true },
	{ name: 'bone thrower', id: BONE_THROWER, pos: POS_GROUND, sprite: 0x09, projectile: true },
	{ name: 'Camilla', id: CAMILLA, pos: POS_AIR, sprite: 0x09, boss: true, holdsItem: true, projectile: true },
	...
	{ name: 'flower', id: FLOWER, pos: POS_GROUND, sprite: 0x07, projectile: true },
	{ name: 'gargoyle', id: GARGOYLE, pos: POS_GROUND, sprite: 0x09, projectile: true },
	...
	{ name: 'mudman', id: MUDMAN, pos: POS_GROUND, sprite: 0x03, projectile: true },
	...
	{ name: 'spider', id: SPIDER, pos: POS_AIR, sprite: [ 0x03, 0x09 ], projectile: true },
	{ name: 'swamp ghoul', id: SWAMP_GHOUL, pos: POS_GROUND, sprite: 0x05, projectile: true },
...
enemies.forEach(({ name, id, pos, boss, projectile, holdsItem = false }) => {
	const key = camelcase(name);
	enemy[id] = enemy[key] = function(x, y, data, pointer, opts = {}) {
		return Object.assign({ name, id, pos, boss, projectile, holdsItem, x, y, data, pointer, enemy: true }, opts);
	};
