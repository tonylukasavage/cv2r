...
function modSaleData(romBuffer) {
  ...
  const mod = modData('core', file, saleBank);
  ...
  pm.core.add([...buf], 0x1ECF5);
  pm.core.add([...buf], 0x1ED05);
  pm.core.add([...buf], 0x1ED17);
  ...
  modSubroutine('core', asmFile('saleId.asm'), saleBank, {
    exitOffset: 2,
    values: saleValues,
    invoke: {
      romLoc: 0x1ED46,
...
const itemizer = module.exports = async function itemizer(romBuffer, rng, opts = {}) {
  ...
  modSubroutine('core', asmFile('merchantId.asm'), bank[3], {
    invoke: {
      romLoc: 0x1EDAE,
      padding: 1
    }
...
`;
      ...
      pm.core.add([...textBuf], textRomLoc);
  ...
  modSubroutine('core', asmFile('boss.asm'), bank[1], {
    values: deathValues,
    invoke: {
      romLoc: 0x47D7,
  ...
  modSubroutine('core', asmFile('orb.asm'), bank[1], {
    values: orbValues,
    invoke: {
      romLoc: 0x47A7,
      padding: 1 
  ...
  modSubroutine('core', asmFile('merchantWhip.asm'), bank[3], {
  ...
  modSubroutine('core', asmFile('merchant.asm'), bank[3], {
    exitOffset: 4,
